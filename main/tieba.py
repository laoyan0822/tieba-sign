...
class tieba:
    # bduss
    bduss = 'EwzbncxdUZhdVZ5T0x3SU9JNTZzNHN1YUNReHNJZ1VNWFplOEFmZ29uc0J0RFZnSVFBQUFBJCQAAAAAAAAAAAEAAAAEaP8AaGNjMjIAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAEnDmABJw5gZ'
    # 填入自己的百度id
    myid = 'hcc22'
